...
class MY_Controller extends MX_Controller {
	...
	public function __construct()
	{
		...
		if(isset($lang_config['available'])){
			...
			$this->mViewData['currency_symbol']=$lang_config['available'][$language]['currency_symbol'];
			$this->mViewData['currency_rate']=$lang_config['available'][$language]['currency_rate'];
		}
	}
	...
	private function _setup()
	{
		...
		if ( !empty($lang_config) )
		{
			...
			$this->mCurrency_symbol=$lang_config['available'][$language]['currency_symbol'];
			$this->mCurrency_rate=$lang_config['available'][$language]['currency_rate'];
		}
	...
	protected function render($view_file, $layout = 'default')
	{
		...
		$this->mViewData['currency_symbol'] = $this->mCurrency_symbol;
		$this->mViewData['currency_rate'] = $this->mCurrency_rate;
