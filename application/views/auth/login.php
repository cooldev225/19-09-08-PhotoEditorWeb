...
<div id="mobile" class="clearfix"> 
    <div id="template_wrapper"><!--TEMPLATE WRAPPER-->
        ...
        <?php $this->load->view('auth/login_body.php'); ?>
	</div> 
...
<script type="text/javascript">
var Page_ValidationSummaries =  new Array(document.getElementById("ctl00_ContentPlaceHolder1_uc_customer_login21_ValidationSummary2"));
var Page_Validators =  new Array(document.getElementById("ctl00_ContentPlaceHolder1_uc_customer_login21_RequiredFieldValidator4"), document.getElementById("ctl00_ContentPlaceHolder1_uc_customer_login21_RequiredFieldValidator5"));
</script>

<script type="text/javascript">
var ctl00_ContentPlaceHolder1_uc_customer_login21_RequiredFieldValidator4 = document.all ? document.all["ctl00_ContentPlaceHolder1_uc_customer_login21_RequiredFieldValidator4"] : document.getElementById("ctl00_ContentPlaceHolder1_uc_customer_login21_RequiredFieldValidator4");
ctl00_ContentPlaceHolder1_uc_customer_login21_RequiredFieldValidator4.controltovalidate = "ctl00_ContentPlaceHolder1_uc_customer_login21_txtLoginEmail";
ctl00_ContentPlaceHolder1_uc_customer_login21_RequiredFieldValidator4.errormessage = "Email is required";
ctl00_ContentPlaceHolder1_uc_customer_login21_RequiredFieldValidator4.validationGroup = "vgLogin";
ctl00_ContentPlaceHolder1_uc_customer_login21_RequiredFieldValidator4.evaluationfunction = "RequiredFieldValidatorEvaluateIsValid";
ctl00_ContentPlaceHolder1_uc_customer_login21_RequiredFieldValidator4.initialvalue = "";
var ctl00_ContentPlaceHolder1_uc_customer_login21_RequiredFieldValidator5 = document.all ? document.all["ctl00_ContentPlaceHolder1_uc_customer_login21_RequiredFieldValidator5"] : document.getElementById("ctl00_ContentPlaceHolder1_uc_customer_login21_RequiredFieldValidator5");
ctl00_ContentPlaceHolder1_uc_customer_login21_RequiredFieldValidator5.controltovalidate = "ctl00_ContentPlaceHolder1_uc_customer_login21_txtLoginPassword";
ctl00_ContentPlaceHolder1_uc_customer_login21_RequiredFieldValidator5.errormessage = "Password is required";
ctl00_ContentPlaceHolder1_uc_customer_login21_RequiredFieldValidator5.validationGroup = "vgLogin";
ctl00_ContentPlaceHolder1_uc_customer_login21_RequiredFieldValidator5.evaluationfunction = "RequiredFieldValidatorEvaluateIsValid";
ctl00_ContentPlaceHolder1_uc_customer_login21_RequiredFieldValidator5.initialvalue = "";
var ctl00_ContentPlaceHolder1_uc_customer_login21_ValidationSummary2 = document.all ? document.all["ctl00_ContentPlaceHolder1_uc_customer_login21_ValidationSummary2"] : document.getElementById("ctl00_ContentPlaceHolder1_uc_customer_login21_ValidationSummary2");
ctl00_ContentPlaceHolder1_uc_customer_login21_ValidationSummary2.displaymode = "List";
ctl00_ContentPlaceHolder1_uc_customer_login21_ValidationSummary2.validationGroup = "vgLogin";
</script>
<script type="text/javascript">
