...
var Pixastic = (function() {
    ...
    return {
        ...
        // load the image file
        process: function(img, actionName, options, callback, callbackData) {
            ...
            if (img.tagName.toLowerCase() == "img") {
                ...
                if (dataImg.complete) {
                    ...
                    if (callback) callback(res, callbackData);
                    return res;
                } else {
                    dataImg.onload = function() {
                        var res = Pixastic.applyAction(img, dataImg, actionName, options)
        ...
        Client: {
            ...
            isIE: function() {
                return !!document.all && !!window.attachEvent && !window.opera && !window.performance;
            }
        },
